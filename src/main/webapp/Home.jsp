                        ...
                        <c:forEach items="${listP}" var="o">
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title show_txt"><a href="Detail?pid=${o.id}" title="Xem chi tiết">${o.name}</a></h4>
                                        ...
                                        <div class="row">
                                            ...
                                            <!-- 
                                            <div class="col">
                                                <a href="cart?action=add&id=${o.id}" class="btn btn-success btn-block">Add to cart</a>
                                            </div>
                                             -->
                                        </div>
                                    </div>
